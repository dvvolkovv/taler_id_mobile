...
/// Desktop-shaped onboarding: single centered 640x440 card with notifications
...
class _OnboardingDesktopScreenState extends State<OnboardingDesktopScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          OnboardingAnimatedBackground(animation: _bgCtrl),
          Center(
            child: Material(
              elevation: 12,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    PermissionRowCard(
                      ...
                      title: 'Уведомления',
                      description:
                          'Сообщения в трее и звонки когда окно свёрнуто',
                    ...
                    PermissionRowCard(
                      ...
                      title: 'Микрофон',
                      description:
                          'Голосовой ассистент и голосовые сообщения',
